...
if ( !class_exists( "WCWH_AccPeriod_Class" ) ) 
{

class WCWH_AccPeriod_Class extends WC_DocumentTemplate 
{
	...
	public $Notices;
	public $className = "AccPeriod_Class";

	private $doc_type = 'account_period';
