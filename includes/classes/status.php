...
if ( !class_exists( "WCWH_Status_Class" ) ) 
{

class WCWH_Status_Class extends WCWH_CRUD_Controller 
{
	protected $section_id = "wh_status";

	protected $tbl = "status";
	...
	public function get_infos( $filters = [], $order = [], $single = false, $args = [], $group = [], $limit = [] )
	{
		...
		{
			$cond.= $wpdb->prepare( "AND a.key = %s ", $filters['key'] );
		}
