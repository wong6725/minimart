...
if ( !class_exists( "WCWH_OrderType_Class" ) ) 
{

class WCWH_OrderType_Class extends WCWH_CRUD_Controller 
{
	protected $section_id = "wh_items_order_type";

	protected $tbl = "item_reorder_type";
	...
	public $Notices;
	public $className = "OrderType_Class";
	...
	public function get_export_data( $filters = array(), $single = false )
	{
		...
		$field = "a.name, a.code, a.desc, a.lead_time, a.order_period ";
