...
if ( !class_exists( "WCWH_MarginingSect" ) )
{

class WCWH_MarginingSect extends WCWH_CRUD_Controller
{
    protected $section_id = "wh_margining";

    protected $tbl = "margining_sect";
    ...
    public $Notices;
    public $className = "WCWH_MarginingSect";
