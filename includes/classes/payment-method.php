...
if ( !class_exists( "WCWH_PaymentMethod_Class" ) ) 
{

class WCWH_PaymentMethod_Class extends WCWH_CRUD_Controller 
{
	protected $section_id = "wh_payment_method";

	protected $tbl = "payment_method";
	...
	public $Notices;
	public $className = "PaymentMethod_Class";
	...
	public function get_infos( $filters = [], $order = [], $single = false, $args = [], $group = [], $limit = [] )
	{
		...
		if( isset( $filters['creditability'] ) )
		{
			$cond.= $wpdb->prepare( "AND a.creditability = %s ", $filters['creditability'] );
		}
		if( isset( $filters['s'] ) )
		{
