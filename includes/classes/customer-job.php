...
if ( !class_exists( "WCWH_CustomerJob_Class" ) ) 
{

class WCWH_CustomerJob_Class extends WCWH_CRUD_Controller 
{
	protected $section_id = "wh_customer_job";

	protected $tbl = "customer_job";
	...
	public $Notices;
	public $className = "CustomerJob_Class";
