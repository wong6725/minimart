...
if ( !class_exists( "WCWH_Scheme_Class" ) ) 
{

class WCWH_Scheme_Class extends WCWH_CRUD_Controller 
{
	protected $section_id = "wh_scheme";

	protected $tbl = "scheme";
	...
	public function get_infos( $filters = [], $order = [], $single = false, $args = [], $group = [], $limit = [] )
	{
		...
		if( empty( $order ) )
		{
			$order = [ 'a.section_id' => 'ASC', 'a.scheme_lvl' => 'ASC' ];
		} 
        $o = array();
