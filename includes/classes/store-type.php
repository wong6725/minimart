...
if ( !class_exists( "WCWH_StoreType_Class" ) ) 
{

class WCWH_StoreType_Class extends WCWH_CRUD_Controller 
{
	protected $section_id = "wh_items_store_type";

	protected $tbl = "item_store_type";
	...
	public $Notices;
	public $className = "StoreType_Class";
