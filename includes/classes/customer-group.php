...
if ( !class_exists( "WCWH_CustomerGroup_Class" ) ) 
{

class WCWH_CustomerGroup_Class extends WCWH_CRUD_Controller 
{
	protected $section_id = "wh_customer_group";

	protected $tbl = "customer_group";
	...
	public $Notices;
	public $className = "CustomerGroup_Class";
