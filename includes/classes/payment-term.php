...
if ( !class_exists( "WCWH_PaymentTerm_Class" ) ) 
{

class WCWH_PaymentTerm_Class extends WCWH_CRUD_Controller 
{
	protected $section_id = "wh_payment_term";

	protected $tbl = "payment_term";
	...
	public $Notices;
	public $className = "PaymentTerm_Class";
