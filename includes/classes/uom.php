...
class WCWH_UOM_Class extends WCWH_CRUD_Controller 
{
	...
	public function get_infos( $filters = [], $order = [], $single = false, $args = [], $group = [], $limit = [] )
	{
		...
		if( isset( $filters['fraction'] ) )
		{
			$cond.= $wpdb->prepare( "AND a.fraction = %d ", $filters['fraction'] );
		}
		if( isset( $filters['s'] ) )
		{
