...
if ( !class_exists( "WCWH_OriginGroup_Class" ) ) 
{

class WCWH_OriginGroup_Class extends WCWH_CRUD_Controller 
{
	protected $section_id = "wh_origin_group";

	protected $tbl = "customer_origin";
	...
	public $Notices;
	public $className = "OriginGroup_Class";
	...
	public function get_infos( $filters = [], $order = [], $single = false, $args = [], $group = [], $limit = [] )
	{
		...
		if( $isParent )
		{
			$field.= ", prt.code AS prt_code, prt.name AS prt_name ";
