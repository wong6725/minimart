...
if ( !class_exists( "WCWH_POSSession_AJAX" ) )
{
	
class WCWH_POSSession_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "POSSession_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_pos_session_action' => false,
            'wh_pos_session_listing' => false,
            'wh_pos_session_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_POSSession_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/posSessionCtrl.php" ); 
    }
     ...
     */
     ...
     public function wh_pos_session_action()
     {
    ...
    public function wh_pos_session_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_pos_session_form()
    {   
        $this->Notices->reset_operation_notice();
        $succ = true;
