...
if ( !class_exists( "WCWH_ServiceCharge_AJAX" ) )
{
	
class WCWH_ServiceCharge_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "ServiceCharge_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_service_charge_action' => false,
            'wh_service_charge_listing' => false,
            'wh_service_charge_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_ServiceCharge_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/servicechargeCtrl.php" ); 
    }
    ...
    public function submission()
    {
        ...
        if( ! isset( $datas['action'] ) || $datas['action'] != 'wcwh_wh_service_charge_submission' ) return false;
     ...
     *	---------------------------------------------------------------------------------------------------
     */
    public function wh_service_charge_action()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_service_charge_listing()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
    	$outcome = array();
    ...
    public function wh_service_charge_form()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
...
new WCWH_ServiceCharge_AJAX( $refs );
}