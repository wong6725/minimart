...
if ( !class_exists( "WCWH_TodoAction_AJAX" ) )
{
	
class WCWH_TodoAction_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "TodoAction_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_todo_action_action' => false,
            'wh_todo_action_listing' => false,
            'wh_todo_action_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_TodoAction_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/todoActionCtrl.php" ); 
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_todo_action_action()
    {
    ...
    public function wh_todo_action_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_todo_action_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
