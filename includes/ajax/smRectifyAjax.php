...
if ( !class_exists( "WCWH_SM_Rectify_AJAX" ) )
{
	
class WCWH_SM_Rectify_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "SM_Rectify_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_stock_movement_rectify_action' => false,
            'wh_stock_movement_rectify_listing' => false,
            'wh_stock_movement_rectify_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_stock_movement_rectify_action()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_stock_movement_rectify_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_stock_movement_rectify_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
