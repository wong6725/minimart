...
if ( !class_exists( "WCWH_StockTakeClose_AJAX" ) )
{
	
class WCWH_StockTakeClose_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "StockTakeClose_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_stocktake_close_action' => false,
            'wh_stocktake_close_listing' => false,
            'wh_stocktake_close_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_StockTakeClose_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/stockTakeCloseCtrl.php" ); 
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_stocktake_close_action()
    {
    ...
    public function wh_stocktake_close_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_stocktake_close_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
...
new WCWH_StockTakeClose_AJAX( $refs );
}