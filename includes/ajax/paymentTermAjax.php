...
if ( !class_exists( "WCWH_PaymentTerm_AJAX" ) )
{
	
class WCWH_PaymentTerm_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "PaymentTerm_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_payment_term_action' => false,
            'wh_payment_term_listing' => false,
            'wh_payment_term_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_payment_term_action()
    {
    ...
    public function wh_payment_term_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_payment_term_form()
    {   
        $this->Notices->reset_operation_notice();
        $succ = true;
...
new WCWH_PaymentTerm_AJAX( $refs );
}