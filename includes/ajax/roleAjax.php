...
if ( !class_exists( "WCWH_Role_AJAX" ) )
{
	
class WCWH_Role_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Role_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_role_action' => false,
            'wh_role_listing' => false,
            'wh_role_form' => false,
        ] );
    }
    ...
    {
        if( ! class_exists( 'WCWH_Role_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/roleCtrl.php" );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_role_action()
    {
    ...
    public function wh_role_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
