...
if ( !class_exists( "WCWH_Scheme_AJAX" ) )
{
	
class WCWH_Scheme_AJAX extends WCWH_AJAX
{
	protected $refs;
    ...
    {
        if( ! class_exists( 'WCWH_Scheme_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/schemeCtrl.php" ); 
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_scheme_action()
    {
    ...
    public function wh_scheme_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_scheme_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
