...
if ( !class_exists( "WCWH_Adjustment_AJAX" ) )
{
	
class WCWH_Adjustment_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Adjustment_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_stock_adjust_action' => false,
            'wh_stock_adjust_listing' => false,
            'wh_stock_adjust_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_stock_adjust_action()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_stock_adjust_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_stock_adjust_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
