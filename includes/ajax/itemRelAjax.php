...
if ( !class_exists( "WCWH_ItemRel_AJAX" ) )
{
	
class WCWH_ItemRel_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "ItemRel_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_items_relation_action' => false,
            'wh_items_relation_listing' => false,
            'wh_items_relation_form' => false,
        ] );
    }
    ...
    public function submission()
    {
        ...
        if( ! isset( $datas['action'] ) || $datas['action'] != 'wcwh_wh_items_relation_submission' ) return false;
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_items_relation_action()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_items_relation_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_items_relation_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
