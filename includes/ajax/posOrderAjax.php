...
if ( !class_exists( "WCWH_PosOrder_AJAX" ) )
{
	
class WCWH_PosOrder_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "PosOrder_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_pos_order_action' => false,
            'wh_pos_order_listing' => false,
            'wh_pos_order_form' => false,
        ] );
    }
     ...
     *	---------------------------------------------------------------------------------------------------
     */
    public function wh_pos_order_action()
    {
    ...
    public function wh_pos_order_listing()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
    	$outcome = array();
    ...
    public function wh_pos_order_form()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
