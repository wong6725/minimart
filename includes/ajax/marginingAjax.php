...
if ( !class_exists( "WCWH_Margining_AJAX" ) )
{
	
class WCWH_Margining_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Margining_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_margining_action' => false,
            'wh_margining_listing' => false,
            'wh_margining_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_margining_action()
    {
    ...
    public function wh_margining_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_margining_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
