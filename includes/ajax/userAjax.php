...
if ( !class_exists( "WCWH_User_AJAX" ) )
{
	
class WCWH_User_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "User_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_maintain_user_action' => false,
            'wh_maintain_user_listing' => false,
            'wh_maintain_user_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_User_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/userCtrl.php" ); 
    }
     ...
     *	---------------------------------------------------------------------------------------------------
     */
    public function wh_maintain_user_action()
    {
    ...
    public function wh_maintain_user_listing()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
    	$outcome = array();
    ...
    public function wh_maintain_user_form()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
