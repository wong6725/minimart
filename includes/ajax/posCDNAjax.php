...
if ( !class_exists( "WCWH_POSCDN_AJAX" ) )
{
	
class WCWH_POSCDN_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "POSCDN_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_pos_cdn_action' => false,
            'wh_pos_cdn_listing' => false,
            'wh_pos_cdn_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_POSCDN_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/posCDNCtrl.php" ); 
    }
     ...
     *	---------------------------------------------------------------------------------------------------
     */
    public function wh_pos_cdn_action()
    {
    ...
    public function wh_pos_cdn_listing()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
    	$outcome = array();
    ...
    public function wh_pos_cdn_form()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
