...
if ( !class_exists( "WCWH_StoreType_AJAX" ) )
{
	
class WCWH_StoreType_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "StoreType_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_items_store_type_action' => false,
            'wh_items_store_type_listing' => false,
            'wh_items_store_type_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_StoreType_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/storeTypeCtrl.php" ); 
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_items_store_type_action()
    {
    ...
    public function wh_items_store_type_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_items_store_type_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
