...
if ( !class_exists( "WCWH_UOM_AJAX" ) )
{
	
class WCWH_UOM_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "UOM_AJAX";
    ...
    {
        if( ! class_exists( 'WCWH_UOM_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/uomCtrl.php" ); 
    }
    ...
    public function wh_uom_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
