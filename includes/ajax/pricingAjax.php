...
if ( !class_exists( "WCWH_Pricing_AJAX" ) )
{
	
class WCWH_Pricing_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Pricing_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_pricing_action' => false,
            'wh_pricing_listing' => false,
            'wh_pricing_form' => false,
            'wh_latest_pricing_listing' => false,
        ] );
    }
    ...
    public function submission()
    {
        ...
        if( ! isset( $datas['action'] ) || $datas['action'] != 'wcwh_wh_pricing_submission' ) return false;
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_pricing_action()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
        ...
        if( $succ && $form )
        {
            ...
            else if( $succ && $listForm && ( isset( $listForm["action"] ) || isset( $listForm["action2"] ) ) )
            {
                ...
                {
                    if( $listForm['action'] == 'wh_pricing' )
                    {
                        $outcome['modal']['title'] = "New Pricing";
    ...
    public function wh_pricing_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_pricing_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
    ...
    public function wh_latest_pricing_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
