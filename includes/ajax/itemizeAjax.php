...
if ( !class_exists( "WCWH_Itemize_AJAX" ) )
{
	
class WCWH_Itemize_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Itemize_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_itemize_action' => false,
            'wh_itemize_listing' => false,
            'wh_itemize_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_Itemize_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/itemizeCtrl.php" ); 
    }
    ...
    public function submission()
    {
        ...
        if( ! isset( $datas['action'] ) || $datas['action'] != 'wcwh_wh_itemize_submission' ) return false;
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_itemize_action()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_itemize_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_itemize_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
