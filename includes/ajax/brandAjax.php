...
if ( !class_exists( "WCWH_Brand_AJAX" ) )
{
	
class WCWH_Brand_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Brand_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_brand_action' => false,
            'wh_brand_listing' => false,
            'wh_brand_form' => false,
        ] );
    }
     ...
     *	---------------------------------------------------------------------------------------------------
     */
    public function wh_brand_action()
    {
    ...
    public function wh_brand_listing()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
    	$outcome = array();
