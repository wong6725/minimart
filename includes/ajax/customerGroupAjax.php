...
if ( !class_exists( "WCWH_CustomerGroup_AJAX" ) )
{
	
class WCWH_CustomerGroup_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "CustomerGroup_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_customer_group_action' => false,
            'wh_customer_group_listing' => false,
            'wh_customer_group_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_customer_group_action()
    {
    ...
    public function wh_customer_group_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_customer_group_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
...
new WCWH_CustomerGroup_AJAX( $refs );
}