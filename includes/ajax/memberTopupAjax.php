...
if ( !class_exists( "WCWH_MemberTopup_AJAX" ) )
{
	
class WCWH_MemberTopup_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "MemberTopup_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_member_topup_action' => false,
            'wh_member_topup_listing' => false,
            'wh_member_topup_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_MemberTopup_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/memberTopupCtrl.php" ); 
    }
    ...
    public function submission()
    {
        ...
        if( ! isset( $datas['action'] ) || $datas['action'] != 'wcwh_wh_member_topup_submission' ) return false;
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_member_topup_action()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_member_topup_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_member_topup_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
...
new WCWH_MemberTopup_AJAX( $refs );
}