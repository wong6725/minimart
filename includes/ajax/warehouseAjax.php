...
if ( !class_exists( "WCWH_Warehouse_AJAX" ) )
{
	
class WCWH_Warehouse_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Warehouse_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_warehouse_action' => false,
            'wh_warehouse_listing' => false,
            'wh_warehouse_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_warehouse_action()
    {
    ...
    public function wh_warehouse_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_warehouse_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
