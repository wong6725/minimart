...
if ( !class_exists( "WCWH_VendingMachine_AJAX" ) )
{
	
class WCWH_VendingMachine_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "VendingMachine_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_vending_machine_action' => false,
            'wh_vending_machine_listing' => false,
            'wh_vending_machine_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_VendingMachine_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/vendingMachineCtrl.php" ); 
    }
     ...
     *	---------------------------------------------------------------------------------------------------
     */
    public function wh_vending_machine_action()
    {
    ...
    public function wh_vending_machine_listing()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
    	$outcome = array();
    ...
    public function wh_vending_machine_form()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
...
new WCWH_VendingMachine_AJAX( $refs );
}