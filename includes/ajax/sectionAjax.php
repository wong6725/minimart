...
if ( !class_exists( "WCWH_Section_AJAX" ) )
{
	
class WCWH_Section_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Section_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_section_action' => false,
            'wh_section_listing' => false,
            'wh_section_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_Section_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/sectionCtrl.php" ); 
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_section_action()
    {
    ...
    public function wh_section_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_section_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
