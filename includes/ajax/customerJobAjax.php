...
if ( !class_exists( "WCWH_CustomerJob_AJAX" ) )
{
	
class WCWH_CustomerJob_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "CustomerJob_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_customer_job_action' => false,
            'wh_customer_job_listing' => false,
            'wh_customer_job_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_customer_job_action()
    {
    ...
    public function wh_customer_job_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_customer_job_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
...
new WCWH_CustomerJob_AJAX( $refs );
}