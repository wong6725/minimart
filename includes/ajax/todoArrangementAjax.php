...
if ( !class_exists( "WCWH_TodoArrangement_AJAX" ) )
{
	
class WCWH_TodoArrangement_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "TodoArrangement_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_arrangement_action' => false,
            'wh_arrangement_listing' => false,
            'wh_arrangement_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_TodoArrangement_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/TodoArrangementCtrl.php" ); 
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_arrangement_action()
    {
    ...
    public function wh_arrangement_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_arrangement_form()
    {   
        $this->Notices->reset_operation_notice();
        $succ = true;
...
new WCWH_TodoArrangement_AJAX( $refs );
}