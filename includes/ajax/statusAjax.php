...
if ( !class_exists( "WCWH_Status_AJAX" ) )
{
	
class WCWH_Status_AJAX extends WCWH_AJAX
{
	protected $refs;
    ...
    {
        if( ! class_exists( 'WCWH_Status_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/statusCtrl.php" ); 
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_status_action()
    {
    ...
    public function wh_status_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_status_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
