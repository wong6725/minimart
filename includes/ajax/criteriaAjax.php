...
if ( !class_exists( "WCWH_Criteria_AJAX" ) )
{
	
class WCWH_Criteria_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Criteria_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_criteria_action' => false,
            'wh_criteria_listing' => false,
            'wh_criteria_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_Criteria_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/criteriaCtrl.php" ); 
    }
     ...
     *	---------------------------------------------------------------------------------------------------
     */
    public function wh_criteria_action()
    {
    ...
    public function wh_criteria_listing()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
    	$outcome = array();
    ...
    public function wh_criteria_form()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
