...
if ( !class_exists( "WCWH_ItemGroup_AJAX" ) )
{
	
class WCWH_ItemGroup_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "ItemGroup_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_items_group_action' => false,
            'wh_items_group_listing' => false,
            'wh_items_group_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_ItemGroup_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/itemGroupCtrl.php" ); 
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_items_group_action()
    {
    ...
    public function wh_items_group_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_items_group_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
