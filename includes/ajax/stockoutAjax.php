...
if ( !class_exists( "WCWH_Stockout_AJAX" ) )
{
	
class WCWH_Stockout_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Scheme_AJAX";
    ...
    {
        if( ! class_exists( 'WCWH_Stockout_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/stockoutCtrl.php" ); 
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_stockout_action()
    {
    ...
    public function wh_stockout_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_stockout_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
