...
if ( !class_exists( "WCWH_OrderType_AJAX" ) )
{
	
class WCWH_OrderType_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "OrderType_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_items_order_type_action' => false,
            'wh_items_order_type_listing' => false,
            'wh_items_order_type_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_OrderType_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/orderTypeCtrl.php" ); 
    }
    ...
    public function submission()
    {
        ...
        if( ! isset( $datas['action'] ) || $datas['action'] != 'wcwh_wh_items_order_type_submission' ) return false;
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_items_order_type_action()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_items_order_type_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_items_order_type_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
