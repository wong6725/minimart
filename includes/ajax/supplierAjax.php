...
if ( !class_exists( "WCWH_Supplier_AJAX" ) )
{
	
class WCWH_Supplier_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Supplier_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_supplier_action' => false,
            'wh_supplier_listing' => false,
            'wh_supplier_form' => false,
        ] );
    }
    ...
    public function submission()
    {
        ...
        if( ! isset( $datas['action'] ) || $datas['action'] != 'wcwh_wh_supplier_submission' ) return false;
     ...
     *	---------------------------------------------------------------------------------------------------
     */
    public function wh_supplier_action()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_supplier_listing()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
    	$outcome = array();
    ...
    public function wh_supplier_form()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
