...
if ( !class_exists( "WCWH_Item_AJAX" ) )
{
	
class WCWH_Item_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Item_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_items_action' => false,
            'wh_items_listing' => false,
            'wh_items_form' => false,
        ] );
    }
    ...
    public function submission()
    {
        ...
        if( ! isset( $datas['action'] ) || $datas['action'] != 'wcwh_wh_items_submission' ) return false;
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_items_action()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_items_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
