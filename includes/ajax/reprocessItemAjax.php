...
if ( !class_exists( "WCWH_ReprocessItem_AJAX" ) )
{
	
class WCWH_ReprocessItem_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "ReprocessItem_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_reprocess_item_action' => false,
            'wh_reprocess_item_listing' => false,
            'wh_reprocess_item_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_reprocess_item_action()
    {
    ...
    public function wh_reprocess_item_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_reprocess_item_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
...
new WCWH_ReprocessItem_AJAX( $refs );
}