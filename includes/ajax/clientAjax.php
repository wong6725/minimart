...
if ( !class_exists( "WCWH_Client_AJAX" ) )
{
	
class WCWH_Client_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Client_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_client_action' => false,
            'wh_client_listing' => false,
            'wh_client_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_Client_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/clientCtrl.php" ); 
    }
     ...
     *	---------------------------------------------------------------------------------------------------
     */
    public function wh_client_action()
    {
    ...
    public function wh_client_listing()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
    	$outcome = array();
    ...
    public function wh_client_form()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
