...
if ( !class_exists( "WCWH_OriginGroup_AJAX" ) )
{
	
class WCWH_OriginGroup_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "OriginGroup_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_origin_group_action' => false,
            'wh_origin_group_listing' => false,
            'wh_origin_group_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_origin_group_action()
    {
    ...
    public function wh_origin_group_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_origin_group_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
...
new WCWH_OriginGroup_AJAX( $refs );
}