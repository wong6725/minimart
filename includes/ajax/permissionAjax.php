...
if ( !class_exists( "WCWH_Permission_AJAX" ) )
{
	
class WCWH_Permission_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Permission_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_permission_action' => false,
            'wh_permission_listing' => false,
            'wh_permission_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_permission_action()
    {
    ...
    public function wh_permission_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_permission_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
