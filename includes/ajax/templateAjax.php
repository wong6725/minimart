...
if ( !class_exists( "WCWH_Template_AJAX" ) )
{
	
class WCWH_Template_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Template_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_template_action' => false,
            'wh_template_listing' => false,
            'wh_template_form' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_Template_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/templateCtrl.php" ); 
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_template_action()
    {
    ...
    public function wh_template_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_template_form()
    {   
        $this->Notices->reset_operation_notice();
        $succ = true;
