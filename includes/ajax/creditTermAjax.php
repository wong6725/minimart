...
if ( !class_exists( "WCWH_CreditTerm_AJAX" ) )
{
	
class WCWH_CreditTerm_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "CreditTerm_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_credit_term_action' => false,
            'wh_credit_term_listing' => false,
            'wh_credit_term_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_credit_term_action()
    {
    ...
    public function wh_credit_term_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_credit_term_form()
    {   
        $this->Notices->reset_operation_notice();
        $succ = true;
