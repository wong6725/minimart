...
if ( !class_exists( "WCWH_Asset_AJAX" ) )
{
	
class WCWH_Asset_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Asset_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_asset_action' => false,
            'wh_asset_listing' => false,
            'wh_asset_form' => false,
            'wh_asset_movement_action' => false,
            'wh_asset_movement_listing' => false,
        ] );
    }
    ...
    public function includes()
    {
        ...
        if( ! class_exists( 'WCWH_AssetMovement_Controller' ) ) include_once( WCWH_DIR . "/includes/controller/assetMovementCtrl.php" ); 
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_asset_action()
    {
    ...
    public function wh_asset_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_asset_movement_action()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_asset_movement_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
