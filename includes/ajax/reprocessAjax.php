...
if ( !class_exists( "WCWH_Reprocess_AJAX" ) )
{
	
class WCWH_Reprocess_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Reprocess_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_reprocess_action' => false,
            'wh_reprocess_listing' => false,
            'wh_reprocess_form' => false,
        ] );
    }
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function wh_reprocess_action()
    {
    ...
    public function wh_reprocess_listing()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
    ...
    public function wh_reprocess_form()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
