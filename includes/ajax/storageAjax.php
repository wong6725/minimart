...
if ( !class_exists( "WCWH_Storage_AJAX" ) )
{
	
class WCWH_Storage_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "Storage_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'wh_storage_action' => false,
            'wh_storage_listing' => false,
            'wh_storage_form' => false,
        ] );
    }
     ...
     *	---------------------------------------------------------------------------------------------------
     */
    public function wh_storage_action()
    {
    ...
    public function wh_storage_listing()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
    	$outcome = array();
    ...
    public function wh_storage_form()
    {
    	$this->Notices->reset_operation_notice();
    	$succ = true;
