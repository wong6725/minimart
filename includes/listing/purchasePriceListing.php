...
class WCWH_PurchasePrice_Listing extends WCWH_Listing 
{	
	protected $refs;
	...
	public function get_bulk_actions() 
	{
		...
		if( current_user_can( 'save_'.$this->section_id ) )
			$actions['wh_purchase_pricing'] = "New PurchasePricing";
	...
	?>
		...
		?>
			<div class="segment col-md-4">
				<label class="" for="flag">By Purchaser <sup>Current: <?php echo $options[$this->filters['seller']]; ?></sup></label>
				<?php
	...
	{
		$html = $item['docno'];
		$args = [ 'id'=>$item['price_id'], 'service'=>'wh_purchase_pricing_action', 'title'=>$html, 'permission'=>[ 'access_wh_purchase_pricing' ] ];
		return $this->get_external_btn( $html, $args );
	}
