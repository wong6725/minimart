...
class WCWH_VendingMachine_Listing extends WCWH_Listing 
{	
	protected $refs;
	...
	public function get_columns() 
	{
		return array(
			...
			"name" 		=> "Machine",
			"code" 		=> "Code",
			"machine_no"=> "Machine No. / Serial",
			"comp_id"	=> "Company",
			"warehouse_id" 	=> "Warehouse / Outlet",
			"location"	=> "Location",
			"status"	=> "Status",
	...
	{
		$html = $item['wh_code']." - ".$item['wh_name'];
		$args = [ 'id'=>$item['wh_id'], 'service'=>'wh_warehouse_action', 'title'=>$html, 'permission'=>[ 'access_wh_warehouse' ] ];
		return $this->get_external_btn( $html, $args );
	}
