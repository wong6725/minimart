...
class WCWH_BlockAction_Listing extends WCWH_Listing 
{	
	protected $refs;
	...
	?>
		<div class="row">
			...
			<div class="col-md-4">
				...
				<?php
					$options = options_data( $this->block_actions );
	                wcwh_form_field( 'filter[block_action_type]', 
	                    [ 'id'=>'', 'type'=>'select', 'label'=>'', 'required'=>false, 'attrs'=>[], 'class'=>['select2'],
	                        'options'=> $options, 
	                    ], 
	                    isset( $this->filters['block_action_type'] )? $this->filters['block_action_type'] : '', $view 
	                ); 
				?>
			</div>
	...
	public function column_block_action( $item )
	{
		return $this->block_actions[ $item['block_action_type'] ];
	}

	public function column_block_reason( $item )
	{
		return $this->brs[ $item['block_reason'] ];
	}
