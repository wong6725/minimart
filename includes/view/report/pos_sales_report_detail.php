...
<div class="each_order">
	...
	<?php if( $header['cash_paid'] ): ?>
		<tr>
			<th colspan="3" class="rightered"><?php echo ( $header['payment_method_title'] )? $header['payment_method_title'] : $header['payment_method'] ?>: </th><th class="rightered"><?php echo round_to( $header['cash_paid'], 2, true ); ?></th>
		</tr>
		<tr>
