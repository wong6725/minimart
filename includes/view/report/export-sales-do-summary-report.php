        ...
        <div class="form-row">
            ...
            <?php 
                ...
                wcwh_form_field( 'doc_id[]', 
                    [ 'id'=>'', 'type'=>'select', 'label'=>'By DO No.', 'required'=>false, 'attrs'=>[], 'class'=>['select2','modalSelect'], 
                        'options'=> $options, 'multiple'=>1
                    ], 
                    $filters['doc_id'], $view 
                ); 
...
<?php else: ?>
    <div class='form-rows-group'>
        ...
        <div class="form-row">
            <div class="col form-group">
            <?php 
                $options = [ 'sale'=>'Sale Only', 'cost'=>'Cost Only', 'both'=>'Sale & Cost' ];

                wcwh_form_field( 'listing_total', 
                    [ 'id'=>'', 'type'=>'select', 'label'=>'Listing Total', 'required'=>false, 
                        'attrs'=>[], 'class'=>[], 
                        'options'=>$options
                    ], 
                    'sale', $view 
