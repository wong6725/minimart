    ...
    <div class='form-rows-group'>
        ...
        <div class="form-row">
            ...
            <?php
                ...
                wcwh_form_field( 'uom[]', 
                    [ 'id'=>'uom', 'type'=>'select', 'label'=>'By UOM', 'required'=>false, 'attrs'=>[], 'class'=>['select2', 'modalSelect'],
                        'options'=> $options, 'multiple'=>1
                    ], 
                    $filters['uom'], $view 
                ); 
            ...
            <?php 
                ...
                wcwh_form_field( 'product[]', 
                    [ 'id'=>'product', 'type'=>'select', 'label'=>'By Product', 'required'=>false, 'attrs'=>[], 'class'=>['select2','modalSelect'],
                        'options'=> $options, 'multiple'=>1
                    ], 
