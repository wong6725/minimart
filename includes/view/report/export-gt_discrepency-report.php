    ...
    <div class='form-rows-group'>
        ...
        <div class="form-row">
            ...
            <?php 
                wcwh_form_field( 'from_date', 
                    [ 'id'=>'', 'type'=>'text', 'label'=>'From Date', 'required'=>false, 'class'=>['doc_date', 'picker'],
            ...
            <?php 
                wcwh_form_field( 'to_date', 
                    [ 'id'=>'', 'type'=>'text', 'label'=>'To Date', 'required'=>false, 'class'=>['doc_date', 'picker'], 
        ...
        <div class="form-row">
            <div class="col form-group">
                <?php
                    ...
                    $wh = apply_filters( 'wcwh_get_warehouse', [ 'status'=>1, 'visible'=>1 ], [], false );
                    $options = options_data( $wh, 'code', [ 'code', 'name' ], '' );

                    wcwh_form_field( 'warehouse_id[]', 
                        [ 'id'=>'', 'type'=>'select', 'label'=>'Warehouse', 'required'=>false, 'attrs'=>[], 'class'=>['select2','modalSelect'],
                            'options'=> $options, 'multiple'=>1
                        ], 
                        isset( $filters['warehouse_id'] )? $filters['warehouse_id'] : '', $view 
                    );
                ?>
        ...
        <div class="form-row">
            ...
            <?php 
                ...
                $options = options_data( apply_filters( 'wcwh_get_item_category', $filter, [], false, ['base'=>1] ), 'slug', [ 'slug', 'name' ], '' );
            ...
            <?php 
                $filter = [];
                if( $filters['seller'] ) $filter['seller'] = $filters['seller'];
                $options = options_data( apply_filters( 'wcwh_get_item', $filter, [], false, [ 'uom'=>1, 'usage'=>1, 'needTree'=>1, 'treeOrder'=>['breadcrumb_code','asc'] ] ), 'serial', [ 'code', '_uom_code', 'name' ], '' );
