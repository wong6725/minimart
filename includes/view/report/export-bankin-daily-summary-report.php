        ...
        <div class="form-row">
            ...
            <?php 
                wcwh_form_field( 'from_date', 
                    [ 'id'=>'from_date', 'type'=>'text', 'label'=>'From Post Date', 'required'=>false, 'class'=>['doc_date', 'picker'],
            ...
            <?php 
                wcwh_form_field( 'to_date', 
                    [ 'id'=>'to_date', 'type'=>'text', 'label'=>'To Post Date', 'required'=>false, 'class'=>['doc_date', 'picker'], 
