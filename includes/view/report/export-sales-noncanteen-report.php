...
?>
    <div class='form-rows-group'>
        ...
        <div class="form-row">
            ...
            <?php 
                $filter = [];
                if( !empty( $args['setting']['non_canteen_einvoice']['exclude_client'] ) ) 
                    $filter['not_id'] = $args['setting']['non_canteen_einvoice']['exclude_client'];
        ...
        <div class="form-row">
            ...
            <?php 
                ...
                wcwh_form_field( 'doc_id[]', 
                    [ 'id'=>'', 'type'=>'select', 'label'=>'By DO No.', 'required'=>false, 'attrs'=>[], 
        ...
        <?php
            wcwh_form_field( 'export_type', 
                ...
                ( $args['export_type'] )? $args['export_type'] : 'non_canteen_einvoice', $view 
            ); 
