...
?>
    <div class='form-rows-group'>
        ...
        <div class="form-row">
            ...
            <?php
                if( $args['DocType'] ):
                    $options = array_merge( [''=>'All'], $args['DocType'] );
                    wcwh_form_field( 'doc_type', 
                        [ 'id'=>'doc_type', 'type'=>'select', 'label'=>'By Document Type', 'required'=>false, 'attrs'=>[], 'class'=>['select2'],
                            'options'=> $options, 
                        ], 
        ...
        <div class="form-row">
            ...
            <?php 
                ...
                wcwh_form_field( 'supplier[]', 
                    [ 'id'=>'supplier', 'type'=>'select', 'label'=>'By Supplier', 'required'=>false, 'attrs'=>[], 'class'=>['select2','modalSelect'],
