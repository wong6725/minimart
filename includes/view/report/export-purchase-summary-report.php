    ...
    <div class='form-rows-group'>
        ...
        <div class="form-row">
            ...
            <?php 
                ...
                $options = options_data( apply_filters( 'wcwh_get_supplier', $filter ), 'id', [ 'code', 'name' ], 'Select' );
                
                wcwh_form_field( 'supplier[]', 
                    [ 'id'=>'supplier', 'type'=>'select', 'label'=>'Supplier', 'required'=>false, 'attrs'=>[], 'class'=>['select2','modalSelect'],
        ...
        <div class="form-row">
            ...
            <?php 
                $options = [];
                if( !empty( $filters['sequence_doc'] ) )
                {
                    foreach( $filters['sequence_doc'] as $opt )
                    {
                        $options[ $opt ] = $opt;
                    }
                }
                wcwh_form_field( 'sequence_doc[]', 
                    [ 'id'=>'', 'type'=>'select', 'label'=>'Paste PO No. from Excel', 'required'=>false, 'attrs'=>[], 'class'=>['select2Tag','select2Empty'],
                        'options'=> $options, 'multiple'=>1
                    ], 
                    isset( $filters['sequence_doc'] )? $filters['sequence_doc'] : '', $view 
                ); 
            ?>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <?php 
                wcwh_form_field( 'grouping', 
                    [ 'id'=>'', 'type'=>'checkbox', 'label'=>'Group Result', 'required'=>false, 
                        'attrs'=>[], 'class'=>[], 
                    ], 
                    1, $view 
                ); 
