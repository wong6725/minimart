...
?>
    <div class='form-rows-group'>
        ...
        <div class="form-row">
            <div class="col form-group">
            <?php
                $options = array_merge( [''=>'All'], ['good_receive'=>'Goods Receipt', 'reprocess'=>'Reprocess'] );
                wcwh_form_field( 'doc_type', 
                    [ 'id'=>'doc_type', 'type'=>'select', 'label'=>'By Doc Type', 'required'=>false, 'attrs'=>[], 'class'=>['select2'],
                        'options'=> $options, 
                    ], 
                    $filters['doc_type'], $view 
                ); 
            ?>
            </div>
            <div class="col form-group">
        ...
        <div class="form-row">
            ...
            <?php 
                ...
                $options = options_data( apply_filters( 'wcwh_get_supplier', $filter ), 'id', [ 'code', 'name' ] );
                
                wcwh_form_field( 'supplier[]', 
                    [ 'id'=>'supplier', 'type'=>'select', 'label'=>'By Supplier', 'required'=>false, 'attrs'=>[], 
                        'class'=>['select2','modalSelect'],
                        'options'=> $options, 'multiple'=>1
                    ], 
                    $filters['supplier'], $view 
                ); 
            ?>
            </div>
            <div class="col form-group">
        ...
        <?php
            if( $filters['seller'] ) $wh = apply_filters( 'wcwh_get_warehouse', [ 'id'=>$filters['seller'] ], [], true, [] );
        ...
        <div class="form-row">
            ...
            <?php 
                wcwh_form_field( 'follow_dc', 
                    [ 'id'=>'', 'type'=>'checkbox', 'label'=>'Follow DC Document Date', 'required'=>false, 'attrs'=>[], 'class'=>[] ], 
                    isset( $filters['follow_dc'] )? $filters['follow_dc'] : '', $view 
                ); 
            ?>
            </div>
            <div class="col form-group">
