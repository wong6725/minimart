...
?>
    <div class='form-rows-group'>
        ...
        <div class="form-row">
            <div class="col form-group">
            <?php 
                $options = [ 'sap'=>'SAP', 'ref'=>'Detail Reference' ];
                wcwh_form_field( 'list_type', 
                    [ 'id'=>'', 'type'=>'select', 'label'=>'Export For', 'required'=>false, 'attrs'=>[], 'class'=>[],
                        'options'=> $options,
                    ], 
                    isset( $filters['list_type'] )? $filters['list_type'] : '', $view 
                ); 
            ?>
            </div>
            <div class="col form-group">
            <?php 
                if( $args['Customers'] )
                    $options = options_data( $args['Customers'], 'code', [ 'code', 'name' ], '' );
                
                wcwh_form_field( 'customer[]', 
                    [ 'id'=>'customer', 'type'=>'select', 'label'=>'By Customer', 'required'=>false, 'attrs'=>[], 'class'=>['select2','modalSelect'],
