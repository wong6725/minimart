...
>
        ...
        <div class="form-row">
            ...
            <?php 
                wcwh_form_field( 'to_date', 
                    [ 'id'=>'', 'type'=>'text', 'label'=>'Until Date', 'required'=>false, 'attrs'=>[ 'data-dd-format="Y-m-d"' ], 'class'=>['doc_date', 'picker'] ], 
                    '', $view 
                ); 
    ...
    <?php if( current_user_cans( [ 'wh_admin_support' ] ) ): ?>
        <div class="form-row">
            <div class="col form-group flex-row flex-align-center">
            <?php 
                wcwh_form_field( 'pending_gr', 
                    [ 'id'=>'pending_gr', 'type'=>'checkbox', 'label'=>'List Pending GR', 'required'=>false, 'attrs'=>[] ], 
                    '1', $view 
                ); 
            ?>
            </div>
            ...
            <?php
                ...
                wcwh_form_field( 'client_code', 
                    [ 'id'=>'', 'type'=>'select', 'label'=>'Pending GR by Client', 'required'=>false, 'attrs'=>[], 'class'=>['select2','modalSelect'],
                        'options'=> $options, 
                    ], 
                    '', $view 
                ); 
