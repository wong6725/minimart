...
>
    ...
    <div class='form-rows-group'>
		...
		<div class="form-row">
            <div class="col form-group">
            <?php 
                $options = [ 1=>'Ready', 6=>'Posted', 9=>'Completed', 10=> 'Closed' ];
                
                wcwh_form_field( 'status', 
                    [ 'id'=>'items_code', 'type'=>'select', 'label'=>'Status', 'required'=>false, 'attrs'=>[], 'class'=>['select2'],
                        'options'=> $options
                    ], 
                    '', $view 
                ); 
            ...
            <div class="col form-group scheme_ref client_code">
                ...
                <div class="col form-group">
                    <?php 
                        ...
                        // wcwh_form_field( 'status', 
                        //     [ 'id'=>'filter[product_id][]', 'type'=>'select', 'label'=>'Status', 'required'=>false, 'attrs'=>[], 'class'=>['select2'],
                        //         'options'=> $options
                        //     ], 
                        //     '', $view 
                        // );
