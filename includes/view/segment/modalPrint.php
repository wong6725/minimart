...
<div class="modal modalPrint main fade" id="wcwhModalPrint" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
	...
	<script type="text/template" class="footer-action-print">
		<button type="button" class="btn btn-sm btn-secondary action-print">Print <i class="fa fa-print" aria-hidden="true"></i></button>
	</script>
