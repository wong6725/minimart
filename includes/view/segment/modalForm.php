...
<div class="modal modalForm main fade" id="<?php echo ( $args['id'] )? $args['id'] : 'wcwhModalForm' ?>" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" data-keyboard="false" data-backdrop="static" >
