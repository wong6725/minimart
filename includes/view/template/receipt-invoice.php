...
<html>
	<head>
		...
		<title>INVOICE <?php echo $args['heading']['docno']; ?></title>
		<style>
		<?php 
	...
	<div id="header"> 
		...
		<div class="header_content">
			...
			<?php
				...
				{
					echo "<tr>";
					echo "<td valign='top' width='30%'><strong>BILL TO:</strong></td>";
					echo "<td valign='top' class='rightered' width='1%'>:</td>";
		...
		<table border="0" class="" cellspacing="0" cellpadding="0" width="100%" >
			<thead>
				<tr>
					...
					<th valign="top" class="td td-offl td-offr rightered" scope="col" width='10%'>PRICE</th>
					<th valign="top" class="td td-offl td-offr rightered" scope="col" width='10%'>TOTAL</th>
				</tr>
			</thead>
			...
			<?php
				if( $detail )
				{
					...
					{	
						...
						echo "<td class='td td-offl td-offr td-offt td-offb rightered' valign='top'>".round_to( $item['def_sprice'], 2, true, true )."</td>";
						echo "<td class='td td-offl td-offr td-offt td-offb rightered' valign='top'>".round_to( $item['total_amount'], 2, true, true )."</td>";
						echo "</tr>";

						if( !empty( $item['discount'] ) && !empty( $item['disc'] ) )
						{
							echo "<tr>";
							echo "<td class='td td-offl td-offr td-offt td-offb leftered' valign='top'></td>";
							echo "<td class='td td-offl td-offr td-offt td-offb leftered' valign='top'>Discount {$item['disc']}</td>";
							echo "<td class='td td-offl td-offr td-offt td-offb rightered' valign='top'></td>";
							echo "<td class='td td-offl td-offr td-offt td-offb leftered' valign='top'></td>";
							echo "<td class='td td-offl td-offr td-offt td-offb rightered' valign='top'></td>";
							echo "<td class='td td-offl td-offr td-offt td-offb rightered' valign='top'>".round_to( $item['discount']*-1, 2, true, true )."</td>";
							echo "</tr>";
						}
						...
						if( $item['foc'] > 0 )
						{
							echo "<tr>";
							echo "<td class='td td-offl td-offr td-offt td-offb leftered' valign='top'></td>";
							echo "<td class='td td-offl td-offr td-offt td-offb leftered' valign='top'>{$item['item']} (FOC)</td>";
			...
			<tfoot>
				<tr>
					...
					<th class="td td-offl td-offr td-offb leftered"><strong>SUBTOTAL:</strong></th>
					...
					<th class="td td-offl td-offr td-offb rightered"><?php echo round_to( $final_total, 2, true, true ); ?></th>
				</tr>

				<?php if( $heading['discount'] ): ?>
					<?php $discount = round_to( wh_apply_discount( $final_total, $heading['discount'] ), 2 ); ?>
					<tr>
						<th class="td td-offl td-offr td-offb td-offt leftered"></th>
						<th class="td td-offl td-offr td-offb td-offt leftered"><strong>DISCOUNT <?php echo $heading['discount']; ?>:</strong></th>
						<th class="td td-offl td-offr td-offb td-offt rightered"></th>
						<th class="td td-offl td-offr td-offb td-offt leftered"></th>
						<th class="td td-offl td-offr td-offb td-offt rightered"></th>
						<th class="td td-offl td-offr td-offb td-offt rightered"><?php echo round_to( $discount*-1, 2, true, true ); ?></th>
					</tr>
				<?php endif; ?>

				<tr>
					<?php $final_total = $final_total - ( $discount? $discount : 0 ); ?>
					<th class="td td-offl td-offr td-offt leftered"></th>
					<th class="td td-offl td-offr td-offt leftered"><strong>TOTAL:</strong></th>
					<th class="td td-offl td-offr td-offt rightered"></th>
					<th class="td td-offl td-offr td-offt leftered"></th>
					<th class="td td-offl td-offr td-offt rightered"></th>
					<th class="td td-offl td-offr td-offt rightered"><?php echo round_to( $final_total, 2, true, true ); ?></th>
				</tr>
			</tfoot>
		</table>
		<br>
