...
<?php $header = [ 'title'=>'DELIVERY ORDER', 'docno'=>$args['heading']['docno'] ]; ?>
...
?>
		...
		<?php if( $p+1 == sizeof( $pages ) ): ?>
			<tfoot>
				<tr>
					...
					<th class="td td-offr rightered"><?php echo round_to( $totals, 2, true, true ); ?> </th>
	...
	<div id="footer"> 
		...
		<table id="signature" class="td" cellspacing="0" cellpadding="6" width="100%" border="1">
			<tbody>
				<tr>
					<td class="td td-offb leftered" scope="row" rowspan="2" width="31%" valign="top">For <?php echo strtoupper( trim( $heading['sign_holder'] ) ) ?></td>
					<td class="td centered" scope="row" colspan="3">Goods received in good condition by:</td>
				</tr>
				<tr>
					<td class="td leftered" scope="col" width="23%">Transporter</td>
					<td class="td leftered" scope="col" width="23%">Customer</td>
					<td class="td leftered" scope="col" width="23%">Estate</td>
				</tr>
				<tr>
