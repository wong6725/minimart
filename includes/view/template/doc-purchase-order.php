...
<?php $header = [ 'title'=>'PURCHASE ORDER', 'docno'=>$args['heading']['docno'] ]; ?>
		...
		<table id="break" class="td" cellspacing="0" cellpadding="6" width="100%" border="1">
			<thead>
				<tr>
					...
					<th valign="top" class="td td-offr rightered" scope="col" width='8%'>QTY</th>
					...
					<th valign="top" class="td td-offl centered" scope="col" width='11%'>UNIT PRICE<br>(<?php echo $currency; ?>)</th>
					<th valign="top" class="td td-offl centered" scope="col" width='11%'>NETT PRICE<br>(<?php echo $currency; ?>)</th>
				</tr>
			</thead>
		...
		<?php if( $p+1 == sizeof( $pages ) ): ?>
			<tfoot>
				<tr>
					...
					<th class="td td-offb td-offl leftered"></th>
					<th class="td td-offr rightered"><?php echo round_to( $total_foc, 2, true, true ); ?> </th>
					<th class="td td-offr rightered"></th>
