		...
		{ 
			...
			?>
				<div id="header"> 
					...
					<div class="header_title">
						<span><?php echo $args['heading'][$j]['company'] ?></span>
					</div>
					<br>
					<div class="header_content">
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								...
								<td valign='top' class='rightered'><?php echo $args['heading'][$j]['doc_no']; ?></td>
							</tr>
						<?php
							if( !empty( $value['infos1'] ) )
							{
								foreach( $value['infos1'] as $title => $info ){
									echo "<tr>";
							...
							echo "</tr>";
							if( !empty( $value['infos2'] ) )
							{
								foreach( $value['infos2'] as $title => $info ){
									echo "<tr>";
									echo "<td valign='top' width='30%'><strong>{$title}</strong></td>";
									echo "<td valign='top' class='rightered' width='1%'>:</td>";
									echo "<td valign='top' class='rightered'>{$info}</td>";
							...
							<?php
								if( !empty( $value['infos3'] ) )
								{
									foreach( $value['infos3'] as $title => $info ){
										echo "<tr>";
										echo "<td valign='top' width='30%'><strong>{$title}</strong></td>";
										echo "<td valign='top' class='rightered' width='1%'>:</td>";
										echo "<td valign='top' class='rightered'>{$info}</td>";
