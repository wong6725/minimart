...
<?php endif; ?>
    ...
    <div class="header-container">
        ...
        <div class="form-row">
            ...
            <div class="col form-group">
            <?php 
                $options = $args['return_actions'];
                wcwh_form_field( $prefixName.'[return_type]', 
                    [ 'id'=>'', 'type'=>'select', 'label'=>'Action Type', 'required'=>true, 
                        'attrs'=>['data-showhide=".returnReason"'], 'class'=>['optionShowHide'], 
                        'options'=>$options,
                    ], 
                    $datas['return_type'], $view 
                );
            ?>
            </div>
        </div>
    ...
    <?php else: ?>
        <div class="form-row">
            <div class="col form-group returnReason dispose ">
            <?php 
                $options = options_data( $args['return_reasons']['dispose'] );
            ...
            <div class="col form-group returnReason inventory_inbound ">
            <?php 
                $options = options_data( $args['return_reasons']['inventory_inbound'] );
            ...
            <?php
                if( $datas['details'] )
                {
                    foreach( $datas['details'] as $i => $row )
                    {
                        ...
                        $tpl = apply_filters( 'wcwh_get_template_content', 'segment/saleReturn-row.php' );
