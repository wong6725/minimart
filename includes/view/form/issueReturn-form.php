...
<?php endif; ?>
    ...
    <div class="header-container">
        ...
        <div class="form-row">
            ...
            <div class="col form-group">
            <?php 
                $options = $args['issue_returns'];
                wcwh_form_field( $prefixName.'[issue_return_type]', 
                    [ 'id'=>'', 'type'=>'select', 'label'=>'Action Type', 'required'=>true, 
                        'class'=>['optionShowHide'], 
                        'options'=>$options,
                    ], 
                    $datas['issue_return_type'], $view 
                );
            ?>
            </div>
        </div>
            ...
            <?php
                if( $datas['details'] )
                {
                    foreach( $datas['details'] as $i => $row )
                    {
                        ...
                        $tpl = apply_filters( 'wcwh_get_template_content', 'segment/issueReturn-row.php' );
