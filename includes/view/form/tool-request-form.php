    ...
    <div class="header-container">
        ...
        <div class="form-row">
            ...
            <?php 
                ...
                $options = options_data( apply_filters( 'wcwh_get_customer', $filter, [], false, [ 'account'=>1, 'incl'=>$datas['customer_id'] ] ), 'id', [ 'uid', 'code', 'acc_name', 'name', 'status_name' ], '' );

                wcwh_form_field( $prefixName.'[customer_id]', 
                    [ 'id'=>'', 'type'=>'select', 'label'=>'Tools Receiver', 'required'=>true, 'attrs'=>[], 'class'=>['select2Strict'], 
                        'options'=> $options 
                    ], 
        ...
        <div class="form-row">
            ...
            <?php 
                wcwh_form_field( $prefixName.'[remark]', 
                    ...
                    'description'=>'Required to key in the Serial No. for the Tools, Parts, and Requisition form' ], 
                    $datas['remark'], $view 
                ); 
        ...
        <div class="form-row">
            <div class="col form-group">
            <?php 
                wcwh_form_field( $prefixName.'[note]', 
                    [ 'id'=>'', 'type'=>'textarea', 'label'=>'Note', 'required'=>false, 'attrs'=>[], 
                    'description'=>'Remark for internal use / future reference' ], 
                    $datas['note'], $view 
                ); 
            ?>
            </div>
        ...
        <div class="form-row">
            ...
            <?php 
                wcwh_form_field( 'attachments', 
                    [ 'id'=>'', 'type'=>'file', 'label'=>'Attachments', 'required'=>false, 'attrs'=>[], 'multiple'=>1 ], 
                    '', $view 
                ); 
            ...
            <?php
                if( $datas['details'] )
                {
                    ...
                    foreach( $datas['details'] as $i => $row )
                    {
                        ...
                        $arg = $replace;
                        $tpl = apply_filters( 'wcwh_get_template_content', 'segment/toolRequest-row.php', $arg );
                        echo $tpl = str_replace( $find, $replace, $tpl );
