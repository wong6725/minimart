        ...
        <div class="form-row">
            ...
            <?php 
                wcwh_form_field( $prefixName.'[order_no]', 
                    [ 'id'=>'', 'label'=>'Order No.', 'required'=>( $datas['id'] )? false : true, 'attrs'=>[] ], 
                    $datas['order_no'], ( $datas['id'] )? true : false
                ); 
            ?>
            </div>
            <div class="col form-group">
            ...
            <?php
                if( $datas['details'] )
                {
                    foreach( $datas['details'] as $i => $row )
                    {
                        ...
                        $tpl = apply_filters( 'wcwh_get_template_content', 'segment/posOrder-row.php', [] );
