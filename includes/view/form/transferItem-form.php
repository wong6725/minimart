        ...
        <table class="details wp-list-table widefat striped">
            <thead>
                 <tr>
                    ...
                    <th class="item">To Item</th>
                    <th class="qty">From Qty</th>
                    <th class="qty">To Qty</th>
            ...
            <?php
                if( $datas['details'] )
                {
                    foreach( $datas['details'] as $i => $row )
                    {
                        ...
                        $tpl = apply_filters( 'wcwh_get_template_content', 'segment/transferItem-row.php', $row );
