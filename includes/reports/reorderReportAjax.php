...
if ( !class_exists( "WCWH_Reorder_Rpt_AJAX" ) )
{
    
class WCWH_Reorder_Rpt_AJAX extends WCWH_AJAX
{
    protected $refs;

    public $Notices;
    public $className = "Reorder_Rpt_AJAX";
    ...
    {
        if( ! class_exists( 'WCWH_Reorder_Rpt' ) ) include_once( WCWH_DIR . "/includes/reports/reorderReport.php" ); 
    }

    public function submission()
    {
        $section_id = 'reorder_report';
        $datas = $_REQUEST;
    ...
    {   
        ...
        $outcome['segments']['#exportReorderTPL'] = $this->renew_form( $Inst, 'export_form' );
        //$outcome['segments']['#printReorderTPL'] = $this->renew_form( $Inst, 'printing_form' );
...
new WCWH_Reorder_Rpt_AJAX( $refs );
}