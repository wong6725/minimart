...
class WCWH_SO_NonCanteen_Listing extends WCWH_Listing 
{	
	protected $refs;
	...
	?>
		<div class="row">
			...
			<div class="col-md-4 segment">
				...
				<?php
					$filters = [];
					if( !empty( $this->Setting['direct_sales_einvoice']['exclude_client'] ) ) 
                    	$filters['not_id'] = $this->Setting['direct_sales_einvoice']['exclude_client'];
