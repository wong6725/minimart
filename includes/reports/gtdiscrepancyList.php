...
class WCWH_GT_Discrepancy_Report extends WCWH_Listing 
{	
	protected $refs;
	...
	public function get_columns() 
	{
		...
		$cols = array(
			...
			"gr_doc"			=> "GR No.",
			"do_doc"			=> "DO No.",						  
			//"supplier_warehouse_code"	=> "Warhouse Supplier",
			//"supplier_company_code"		=> "Company Supplier",
	...
	?>
		<div class="row">
			...
			<div class="col-md-3 segment">
				<label class="" for="flag">By Warehouse </label><br>
				<?php
					$filters = [];
	                ...
	                wcwh_form_field( 'filter[warehouse_id][]', 
	                    [ 'id'=>'', 'type'=>'select', 'label'=>'', 'required'=>false, 'attrs'=>[], 'class'=>['select2','modalSelect'],
	                        'options'=> $options, 'multiple'=>1
	                    ], 
	                    isset( $this->filters['warehouse_id'] )? $this->filters['warehouse_id'] : '', $view 
	                ); 
				?>
			</div>
			...
			<div class="col-md-6 segment">
				...
				<?php
					$filters = [];
					if( $this->seller ) $filters['seller'] = $this->seller;
					$options = options_data( apply_filters( 'wcwh_get_item_category', $filters, [], false, [] ), 'slug', [ 'slug', 'name' ], '' );
