...
class WCWH_MWTSummary_Report extends WCWH_Listing 
{	
	protected $refs;
	...
	public function column_avg_cost( $item )
	{
		return ( $item['avg_cost'] )? round_to( $item['avg_cost'], 2, 1, 1 ) : '';
	}
