...
class WCWH_ToolRequestFulfilment_Report extends WCWH_Listing 
{	
	protected $refs;
	...
	{
		$clr = "";
		if( ! $item['customer_status'] ) $clr = "clr-red";  
		return "<span class='{$clr}'>".$item['customer']."</span>";
	}
	...
	public function column_customer_code( $item )
	{
		$clr = "";
		if( ! $item['customer_status'] ) $clr = "clr-red";  
		return "<span class='{$clr}'>".$item['customer_code']."</span>";
	}

	public function column_sap_uid( $item )
	{
		$clr = "";
		if( ! $item['customer_status'] ) $clr = "clr-red";  
		return "<span class='{$clr}'>".$item['sap_uid']."</span>";
	}
