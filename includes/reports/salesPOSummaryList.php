...
class WCWH_SO_PO_Summary_report extends WCWH_Listing 
{	
	protected $refs;
	...
	public function print_column_footers( $datas = array(), $all_datas = array() ) 
	{
		...
		if( $datas )
		{
			foreach( $datas as $i => $data )
			{
				...
				$t_amt+= ( $data['line_total'] )? $data['line_total'] : 0;
			}
		}
		...
		foreach ( $columns as $column_key => $column_display_name ) 
		{
			...
			if( $column_key == 'line_total' ) $column_display_name = round_to( $t_amt, 2, 1, 1 );
