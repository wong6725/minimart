<?php
//Written by trainee-Steven based on customerCreditAjax.php for dealing with form in queryReport.php
if (!defined('ABSPATH'))
    exit; // Exit if accessed directly

if ( !class_exists( "WCWH_QueryReport_AJAX" ) )
{
	
class WCWH_QueryReport_AJAX extends WCWH_AJAX
{
	protected $refs;

	public $Notices;
	public $className = "QueryReport_AJAX";
    ...
    {
        if( ! class_exists( 'WCWH_QueryReport' ) ) include_once( WCWH_DIR . "/includes/reports/queryReport.php" );  
    }

    public function submission()
    {
        $section_id = 'query_report';
        $datas = $_REQUEST;
    ...
    public function query_report()
    {
        ...
        $outcome['segments']['#exportQueryReportTPL'] = $this->renew_form( $Inst, 'export_form', '' );
...
new WCWH_QueryReport_AJAX( $refs );
}