...
if ( !class_exists( "WCWH_POSSales_AJAX" ) )
{
    
class WCWH_POSSales_AJAX extends WCWH_AJAX
{
    protected $refs;

    public $Notices;
    public $className = "POSSales_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'pos_summary_report' => false,
            'pos_sales_report' => false,
            'pos_sales_report_detail' => false,
            'pos_sales_detail_report' => false,
            'pos_category_sales_report' => false,
            'pos_item_sales_report' => false,
        ] );
    }
    ...
    public function pos_summary_report()
    {
        ...
        $outcome['segments']['#exportPOSSalesTPL'] = $this->renew_form( $Inst, 'export_form', 'summary' );
        $outcome['segments']['#printPOSSalesTPL'] = $this->renew_form( $Inst, 'printing_form', 'summary' );
    ...
    public function pos_sales_report()
    {
        ...
        //Listing
        $outcome['segments']['.'.$section_id.'-listing-form'] = $this->renew_listing( $Inst, $form, [], $section_id );
        $outcome['segments']['#exportPOSSalesTPL'] = $this->renew_form( $Inst, 'export_form', 'sales' );
        $outcome['segments']['#printPOSSalesTPL'] = $this->renew_form( $Inst, 'printing_form', 'sales' );

        echo json_encode( $outcome );
        die();
    }
    public function pos_sales_report_detail()
    {
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
        ...
        if( $succ && $form )
        {
            if( $form['action'] )
            {
                ...
                switch( $action )
                {
                    case 'view':
                        ob_start();
                            $Inst->pos_sales_report_detail( $form['id'], $listForm['filter'] );
    ...
    public function pos_sales_detail_report()
    {
        $section_id = 'pos_sales_detail_report';
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
        ...
        //Listing
        $outcome['segments']['.'.$section_id.'-listing-form'] = $this->renew_listing( $Inst, $form, [], $section_id );
        $outcome['segments']['#exportPOSSalesTPL'] = $this->renew_form( $Inst, 'export_form', 'details' );
        $outcome['segments']['#printPOSSalesTPL'] = $this->renew_form( $Inst, 'printing_form', 'details' );

        echo json_encode( $outcome );
        die();
    }

    public function pos_category_sales_report()
    {
        $section_id = 'pos_category_sales_report';
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
        ...
        //Listing
        $outcome['segments']['.'.$section_id.'-listing-form'] = $this->renew_listing( $Inst, $form, [], $section_id );
        $outcome['segments']['#exportPOSSalesTPL'] = $this->renew_form( $Inst, 'export_form', 'category' );
        $outcome['segments']['#printPOSSalesTPL'] = $this->renew_form( $Inst, 'printing_form', 'category' );

        echo json_encode( $outcome );
        die();
    }

    public function pos_item_sales_report()
    {
        $section_id = 'pos_item_sales_report';
        $this->Notices->reset_operation_notice();
        $succ = true;
        $outcome = array();
        ...
        //Listing
        $outcome['segments']['.'.$section_id.'-listing-form'] = $this->renew_listing( $Inst, $form, [], $section_id );
        $outcome['segments']['#exportPOSSalesTPL'] = $this->renew_form( $Inst, 'export_form', 'items' );
        $outcome['segments']['#printPOSSalesTPL'] = $this->renew_form( $Inst, 'printing_form', 'items' );
