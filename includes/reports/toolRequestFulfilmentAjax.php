...
if ( !class_exists( "WCWH_ToolRequestFulfilment_AJAX" ) )
{
    
class WCWH_ToolRequestFulfilment_AJAX extends WCWH_AJAX
{
    protected $refs;

    public $Notices;
    public $className = "ToolRequestFulfilment_AJAX";
    ...
    protected function ajax_events( $ajaxs )
    {
        return array_merge( $ajaxs, [
            'tool_request_fulfilment' => false,
        ] );
    }

    public function includes()
    {
        if( ! class_exists( 'WCWH_ToolRequestFulfilment_Rpt' ) ) include_once( WCWH_DIR . "/includes/reports/toolRequestFulfilment.php" ); 
    }

    public function submission()
    {
        $section_id = 'tool_request_fulfilment';
        $datas = $_REQUEST;
     ...
     *  ---------------------------------------------------------------------------------------------------
     */
    public function tool_request_fulfilment()
    {
        $section_id = 'tool_request_fulfilment';
        $this->Notices->reset_operation_notice();
        $succ = true;
...
new WCWH_ToolRequestFulfilment_AJAX( $refs );
}